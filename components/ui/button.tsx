  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        secondary:"bg-lime-500 text-primary-foreground hover:bg-lime-500/90 border-lime-600 border-b-4 active:border-b-0",
        ...
        super:"bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-primary-foreground hover:bg-red-500/90 border-violet-600/50 border-b-4 active:border-b-0",
        ...
        ghost:"bg-transparent text-slate-500 border-tansparent border-0 hover:bg-slate-100",
      },
      size: {
